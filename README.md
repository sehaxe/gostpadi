...
**Рисовалка блок-схем из кода на C** — или из простого текстового
файла. Без рисования руками: скидываешь `main.c` — получаешь схему. Скармливаешь `main.c` — получаешь готовую схему: линии под 90° и
